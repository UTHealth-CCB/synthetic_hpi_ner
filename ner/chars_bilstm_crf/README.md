...
Changes includes: create convert_bio_to_words_tags.py to convert the original CONLL2003 BIO format (https://www.aclweb.org/anthology/W03-0419.pdf) files to words and tags files , create predict.py to generate prediction labels; minor modifications to main.py and build_vocab.py.
