...
if __name__ == '__main__':
    ...
    # Load vocab
    with Path('{}/vocab.words.txt'.format(data_dir)).open() as f:
    ...
    found = 0
    print('Reading GloVe file (may take a while): {}'.format(glove_file))
    with Path(glove_file).open() as f:
    ...
    np.savez_compressed('{}/glove.npz'.format(data_dir), embeddings=embeddings)
